    ...
    jne L2
		...
		jne C2
			...
			jne mas1
				...
				mwrite "Enter your length in kg : "
				call readfloat
			...
			jne mas2
				...
				mwrite "Enter your length in grams : "
				call readfloat
			...
			jne mas3
				...
				mwrite "Enter your length in pounds : "
				call readfloat
			...
			jne mas4
				...
				mwrite "Enter your length in ounces : "
				call readfloat
			...
			jne mas5
				...
				mwrite "Enter your length in tonnes : "
				call readfloat
		...
		jne C3 
			...
			jne tep1
				...
				mwrite "Enter your length in degree Celsius : "
				call readfloat
			...
			jne tep2
				...
				mwrite "Enter your length in degree Farenheight : "
				call readfloat
			...
			jne tep3
				...
				mwrite "Enter your length in Kelvin : "
				call readfloat
		...
		jne C6 
			...
			jne int1
				...
				mwrite "Enter your length in candela : "
				call readfloat
			...
			jne int2
				...
				mwrite "Enter your length in nox : "
				call readfloat
